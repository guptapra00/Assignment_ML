...
#plot(TrainTrainingSet$classe, col="yellow", main="Plot of levels of variable classe within the TrainTrainingSet data set", xlab="classe", ylab="Frequency",ylim=5000)
...
model2 <- train(classe ~. , data=TrainTrainingSet, method="rf",prox=TRUE)
# Predicting:
